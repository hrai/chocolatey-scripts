:: choco install dotnet3.5 -y >> %COMPUTERNAME%.log
:: choco install hipchat -y >> %COMPUTERNAME%.log
:: choco install nunit -version 2.6.4 -y >> %COMPUTERNAME%.log
:: choco install skype -y >> %COMPUTERNAME%.log
